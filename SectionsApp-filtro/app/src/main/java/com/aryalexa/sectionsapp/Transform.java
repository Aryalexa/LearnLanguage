...
public class Transform {
    ...
    public static void main0(String[] args){
        ArrayList<Double> data = ReadWriteRAW.readDoublesfromRaw("jinglebells.raw");

        Complex[][] fft_ = Transform.fft(data);
        ArrayList<Double> res1 = Transform.fft_inv(fft_);

        Complex[][] filt_fft = Transform.substractNoise(fft_);
        ArrayList<Double> res2 = Transform.fft_inv(filt_fft);
